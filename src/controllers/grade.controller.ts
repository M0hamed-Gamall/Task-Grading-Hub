...
const getStudentGrade = asyncWrapper(async(req: Request, res: Response, next: NextFunction) => {
  const taskGrade = await gradeService.taskGrade(req.params.taskId as string, req.user!.id)
